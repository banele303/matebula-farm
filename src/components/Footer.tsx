      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-2 bg-amber-50 px-3 py-2 rounded-lg border border-amber-200 w-fit">
              <span className="w-2 h-2 bg-amber-500 rounded-full animate-pulse shadow-sm shadow-amber-300" />
              <span className="text-xs font-semibold text-amber-700">B-BBEE Level 1 Certified</span>
            </div>
          </div>
          
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-amber-800 relative inline-block">
              Quick Links
            ...
            <nav className="space-y-2.5">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="block text-gray-600 hover:text-amber-700 hover:translate-x-1 transition-all duration-200 text-sm group"
                >
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <a
                ...
                className="flex items-start gap-3 text-gray-600 hover:text-amber-700 transition-colors group"
              >
              ...
              >
                <svg className="w-5 h-5 text-amber-600 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="border-t border-gray-200 pt-6 mt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-600">
            ...
            <div className="flex items-center gap-4">
              <span className="text-amber-700">Empowering communities through sustainable agriculture</span>
            </div>
          </div>
        </div>
      </div>
